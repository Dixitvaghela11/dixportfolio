    ...
    <section id="home" className="relative min-h-screen flex items-center py-8 pt-32 pb-0">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-8 justify-between">
          {/* Left content column */}
          <div className="lg:w-1/2 space-y-6 text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-4xl lg:text-6xl xl:text-7xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500 dark:from-purple-400 dark:to-blue-400 leading-tight pb-2">
              Dixit Vaghela
            </h1>
            ...
            <p className="text-lg md:text-xl dark:text-gray-300 text-gray-700 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 mt-8 justify-center lg:justify-start">
              <Button 
                className={`${theme === 'light' 
                  ...
                  : 'bg-purple-600 hover:bg-purple-700 text-white'} 
                  px-6 py-2.5 rounded-lg font-medium shadow-md transition-all duration-300`}
                asChild
              >
              ...
              <Button 
                className={`${theme === 'light' 
                  ...
                  : 'bg-green-600 hover:bg-green-700 text-white'} 
                  px-6 py-2.5 rounded-lg font-medium flex items-center gap-2 shadow-md transition-all duration-300`}
                asChild
              >
                <a 
          ...
          <div className="lg:w-2/5 flex justify-center mt-4 lg:mt-0 order-1 lg:order-2">
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-purple-500 p-1 bg-gray-900/50 backdrop-blur-sm">
                ...
                <div className="tech-icons absolute inset-0 w-full h-full">
                  {['react', 'laravel', 'php', 'dotnet', 'sql'].map((tech, index) => (
                    <div
                      key={tech}
                      className="absolute w-12 h-12 bg-gray-800/80 backdrop-blur-sm rounded-full flex items-center justify-center border border-gray-700 animate-float z-10"
                      style={{
                        top: `${Math.sin(index * (Math.PI / 2.5)) * 120 + 120}px`,
                        left: `${Math.cos(index * (Math.PI / 2.5)) * 120 + 120}px`,
